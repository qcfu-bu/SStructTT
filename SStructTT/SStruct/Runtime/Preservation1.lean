  ...
  case tup_ex s i mrg1 ty erm ern ihm ihn =>
    ...
    case tup mrg2 rsm rsn =>
      ...
      case tup_M st =>
        ...
        have wrx := mrg3.merge_wr wr2' wr2
        have ⟨H1', H2', mrg', wr', sb, ⟨erm', rsm', wr⟩⟩ :=
          ihm rfl rfl mrg4.sym wrx rsm wr1' st
        clear ihm
      ...
      case tup_N st =>
        ...
        have wrx := mrg3.merge_wr wr1' wr2
        have ⟨H1', H2', mrg', wr', sb, ⟨ern', rsn', wr⟩⟩ :=
          ihn rfl rfl mrg4.sym wrx rsn wr2' st
        clear ihn
        have ⟨H1p, H2p, sb1, sb2, mrg3p⟩ := mrg3.split_subheap sb
        have ⟨Hy, mrg1, mrg2⟩ := mrg'.sym.split mrg3p
        exists Hy, H2p; and_intros
  ...
  case tt =>
    ...
    case tt ct =>
      ...
      case alloc s l h vl =>
        ...
        . apply wr2.insert_tt
        . apply SubHeap.intro (Finmap.singleton l (.tt, ord.e))
          apply Contra.empty.insert ord.e_contra
  ...
  case ff =>
    ...
    case ff ct =>
      ...
      case alloc s l h vl =>
        ...
        . apply mrg0.insert_contra ord.e_contra
        . apply wr2.insert_ff
        . apply SubHeap.intro (Finmap.singleton l (.ff, ord.e))
          apply Contra.empty.insert ord.e_contra
          rw[Finmap.Disjoint.eq_1]; intros; aesop
          apply Finmap.ext_lookup; intro x
          if e: x = l then
